...
var enemyNames = ["Roborto", "Amy the Andriod", "Robo Trumble"];
var enemyHealth = 50;
var enemyAttack = 12;
...
var startGame = function() {
    ...
    for(var i=0; i < enemyNames.length; i++) {
        if (playerHealth > 0) {
            ...
            //use debugger to pause script from running and check what's goingon at that moment in the code 
            //debugger;
            ...
            if (playerHealth > 0 && i < enemyNames.length - 1) {
                //sak if user wants to use the store before the next round
...
var shop = function () {
    ...
    switch (shopOptionPrompt) {
        ...
        default: 
        window.alert("You did not pick a vaid option. Try again.")
